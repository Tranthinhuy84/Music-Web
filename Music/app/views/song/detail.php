...
<head>
<meta charset="utf-8">
<link rel="stylesheet" href="public/css/baihat.css" type="text/css">
...
<b><span style="color:#090F9B; font-size: x-large;;"><center>Danh sách nhạc</center></span></b></h2>
    ...
    <ol id="playlist">
        <li class="current-song"><a href="<?php echo $value["link"]?>"><button>
            ...
            <span style="position: absolute; right:15%;"><?php echo substr($value["dateTime"],0,10)?></span></button></a></li>
    </ol>
