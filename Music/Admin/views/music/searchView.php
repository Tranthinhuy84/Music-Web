...
<a href="index.php?controller=music/add" class="btn btn-primary" style="margin-bottom: 10px;">Thêm ca sĩ</a>
<a href="index.php?controller=music/list" class="btn btn-success" style="margin-bottom: 10px;">Quay lại</a>
