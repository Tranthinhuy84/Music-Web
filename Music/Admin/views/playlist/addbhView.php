<div class="col-md-12" style="margin-top:20px;">
	<div class="panel panel-primary">
		...
		<div class="panel-body">
				...
				?>
			<form action="index.php?controller=playlist/addbh&act=add" method="post" enctype="multipart/form-data">
					...
					<tr>
						...
						<td>
							<select name="baihat" class="form-control" style="margin-top: 10px;margin-bottom:10px; padding: 3px;">
								<?php
									$data = $this->Model->fetch("select * from song where maList!=".$value["maList"]);
									foreach ($data as $key) {
								?>
